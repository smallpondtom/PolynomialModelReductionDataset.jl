...
"""
function Burgers(;spatial_domain::Tuple{Real,Real}, time_domain::Tuple{Real,Real}, Δx::Real, Δt::Real, 
...
## Arguments
- `model::Burgers`: Burgers model
- `μ::Real`: diffusion coefficient

## Returns
- operators
"""
function finite_diff_model(model::Burgers, μ::Real)
