...
export ModifiedKortewegDeVriesBurgersModel, build_fast_solver, integrate_model_fast
...
# ============================================================================
# Fast SIE / CNAB integrator for mKdVB.
# ============================================================================

"""
$(SIGNATURES)
"""
function build_fast_solver(model::ModifiedKortewegDeVriesBurgersModel, params::Dict;
...
Fast SIE or CNAB integrator for mKdVB.
...
"""
function integrate_model_fast(model::ModifiedKortewegDeVriesBurgersModel,
