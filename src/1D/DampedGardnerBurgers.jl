...
export DampedGardnerBurgersModel, build_fast_solver, integrate_model_fast
...
# ============================================================================
# Fast SIE / CNAB integrator for Damped Gardner-Burgers — same structure as
# Gardner. Periodic A is pentadiagonal circulant (FFT-diagonalizable);
# Dirichlet A bakes Δt into boundary rows (LU fallback).
# ============================================================================

"""
$(SIGNATURES)
"""
function build_fast_solver(model::DampedGardnerBurgersModel, params::Dict;
...
Fast SIE or CNAB integrator for Damped Gardner-Burgers.
...
"""
function integrate_model_fast(model::DampedGardnerBurgersModel, solver::AbstractFastSolver,
